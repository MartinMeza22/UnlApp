...
-- This script cleans all data and reloads the initial dataset
-- ============================================================================
...
-- ============================================================================
-- CLEANUP SECTION - Remove all data in reverse dependency order
-- ============================================================================

-- Remove event data
TRUNCATE TABLE evento;

-- Remove comments (depends on users and publications)
TRUNCATE TABLE Comentario;

-- Remove publications (depends on users and subjects)
TRUNCATE TABLE Publicacion;

-- Remove user-subject relationships
TRUNCATE TABLE usuario_materia;

-- Remove subjects (depends on careers)
TRUNCATE TABLE Materia;

-- Remove users (depends on careers)
TRUNCATE TABLE Usuario;

-- Remove careers (independent)
